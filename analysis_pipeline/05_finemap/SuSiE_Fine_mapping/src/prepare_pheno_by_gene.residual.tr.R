...
pheno_dir <- "/lustre/home/xdzou/2024-10-21-GTBMap/2026-02-02-GTOP_eQTL_mapping/output/sQTL_residual/tu/"
...
for(i in 1:dim(df_genes)[1]){
	...
	outdir <- paste0("/flashfs1/scratch.global/xdzou/Fine_map_susie_tu/output/TR/",opt$tissue,"/",gene)
