...
setwd("/media/london_A/mengxin/GTOP_code/supp/supp_fig13/input")


# supp.Figure.13a proportion of novel & annotated in module ---------------
...
# Supp.Figure.13b annotated modules & unannotated modules -----------------
